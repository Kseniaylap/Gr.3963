//задача 69 Два числа, программа выводит число a в степень b с помощью рекурсии
...
// {
//     if (b <= 1)//точка остановки
//     {
//         return a;//точка остановки
//     }
//     else { return a * (RecPow(a, b - 1)); }//рекурентный вызов
// }
// int a = ReadDataToInt("Введите число a: ");
// int b = ReadDataToInt("Введите число b: ");
// Console.WriteLine();
